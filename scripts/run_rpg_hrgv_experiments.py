...
CONFIGURATION_FLAGS = {
    ...
    "rpg_without_within": (
        *RSG_FLAGS, "--enable-rpg", "--rpg-entropy-mode", "without_within",
    ),
    "rpg_without_between": (
        *RSG_FLAGS, "--enable-rpg", "--rpg-entropy-mode", "without_between",
    ),
    "rpg_total_entropy_only": (
        *RSG_FLAGS, "--enable-rpg", "--rpg-entropy-mode", "total_only",
    ),
}
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the registered RPG-HRGV experiment matrix.")
